...
class OdiaVakyanshBenchmarkTest {

    companion object {
        private const val TAG = "OdiaVakyanshBenchmark"
        private const val MODEL_PATH = "/data/local/tmp/vakyansh_odia_base.int8.onnx"
        private const val EXPECTED_SHA256 = "a0d3c21cf9b8a057779d92e678cc05c3b46142efe5767ba506e0a644ca8c8bba"

        val VOCAB = arrayOf(
            "<s>", "<pad>", "</s>", "<unk>", "|",
            "ଁ", "ଂ", "ଃ", "ଅ", "ଆ", "ଇ", "ଈ", "ଉ", "ଊ", "ଋ", "ଏ", "ଓ", "ଔ",
            "କ", "ଖ", "ଗ", "ଘ", "ଙ", "ଚ", "ଛ", "ଜ", "ଝ", "ଞ", "ଟ", "ଠ", "ଡ", "ଢ", "ଣ",
            "ତ", "ଥ", "ଦ", "ଧ", "ନ", "ପ", "ଫ", "ବ", "ଭ", "ମ", "ଯ", "ର", "ଲ", "ଳ", "ଶ",
            "ଷ", "ସ", "ହ", "଼", "ା", "ି", "ୀ", "ୁ", "ୂ", "ୃ", "େ", "ୈ", "ୋ", "ୌ", "୍",
            "ୟ", "ୱ"
        )
    }
    ...
    @Test
    fun benchmarkOdiaVakyanshOnDevice() {
        val modelFile = File(MODEL_PATH)
        Log.i(TAG, "Starting Android Odia Vakyansh Benchmark on device...")
        ...
        if (session != null) {
            val testDir = File("/data/local/tmp/odia_test")
            ...
            Log.i(TAG, "--- ON-DEVICE ODIA BENCHMARK SUMMARY ---")
        ...
        val outJsonFile = File(context.filesDir, "odia_android_results.json")
