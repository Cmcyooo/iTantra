...
class BengaliVakyanshBenchmarkTest {

    companion object {
        private const val TAG = "BengaliVakyanshBenchmark"
        private const val MODEL_PATH = "/data/local/tmp/vakyansh_bengali_base.int8.onnx"
        private const val EXPECTED_SHA256 = "8aec0865d879c1428f413fe70e6c5f9ff22a2dd678c66f529be4f5794e49b961"
        ...
        val VOCAB = arrayOf(
            ...
            "স", "হ", "়", "া", "ি", "ী", "ু", "ূ", "ৃ", "ে", "ৈ", "ো", "ৌ", "্", "ৎ", "য়"
        )
    }
    ...
    @Test
    fun benchmarkBengaliVakyanshOnDevice() {
        val modelFile = File(MODEL_PATH)
        Log.i(TAG, "Starting Android Bengali Vakyansh Benchmark on device...")
        ...
        if (session != null) {
            val testDir = File("/data/local/tmp/bengali_test")
            ...
            Log.i(TAG, "--- ON-DEVICE BENGALI BENCHMARK SUMMARY ---")
        ...
        val outJsonFile = File(context.filesDir, "bengali_android_results.json")
