...
class TeluguVakyanshBenchmarkTest {

    companion object {
        private const val TAG = "TeluguVakyanshBenchmark"
        private const val MODEL_PATH = "/data/local/tmp/vakyansh_telugu_base.int8.onnx"
        private const val EXPECTED_SHA256 = "c64bab6c69e7965d512c3b6d70fcf5f8e4f2f6e52e6c06307612c489bfd964bf"

        val VOCAB = arrayOf(
            "<s>", "<pad>", "</s>", "<unk>", "|",
            "ం", "ః", "అ", "ఆ", "ఇ", "ఈ", "ఉ", "ఊ", "ఋ", "ఎ", "ఏ", "ఐ", "ఒ", "ఓ", "ఔ",
            "క", "ఖ", "గ", "ఘ", "ఙ", "చ", "ఛ", "జ", "ఝ", "ఞ", "ట", "ఠ", "డ", "ఢ", "ణ",
            "త", "థ", "ద", "ధ", "న", "ప", "ఫ", "బ", "భ", "మ", "య", "ర", "ఱ", "ల", "ళ",
            "వ", "శ", "ష", "స", "హ", "ా", "ి", "ీ", "ు", "ూ", "ృ", "ె", "ే", "ై", "ొ", "ో",
            "ౌ", "్"
        )
    }
    ...
    @Test
    fun benchmarkTeluguVakyanshOnDevice() {
        val modelFile = File(MODEL_PATH)
        Log.i(TAG, "Starting Android Telugu Vakyansh Benchmark on device...")
        ...
        if (session != null) {
            val testDir = File("/data/local/tmp/telugu_test")
            ...
            Log.i(TAG, "--- ON-DEVICE TELUGU BENCHMARK SUMMARY ---")
        ...
        val outJsonFile = File(context.filesDir, "telugu_android_results.json")
