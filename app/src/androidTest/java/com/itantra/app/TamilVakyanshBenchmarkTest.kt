...
class TamilVakyanshBenchmarkTest {

    companion object {
        private const val TAG = "TamilVakyanshBenchmark"
        private const val MODEL_PATH = "/data/local/tmp/vakyansh_tamil_base.int8.onnx"
        private const val EXPECTED_SHA256 = "33a91f3bce4b4025b0c561cde40fce2f029b1cc4ec85c8401f0869d030bb43b2"

        val VOCAB = arrayOf(
            "<s>", "<pad>", "</s>", "<unk>", "|",
            "ஃ", "அ", "ஆ", "இ", "ஈ", "உ", "ஊ", "எ", "ஏ", "ஐ", "ஒ", "ஓ", "ஔ",
            "க", "ங", "ச", "ஜ", "ஞ", "ட", "ண", "த", "ந", "ன", "ப", "ம", "ய",
            "ர", "ற", "ல", "ள", "ழ", "வ", "ஶ", "ஷ", "ஸ", "ஹ", "ா", "ி", "ீ",
            "ு", "ூ", "ெ", "ே", "ை", "ொ", "ோ", "ௌ", "்"
        )
    }
    ...
    @Test
    fun benchmarkTamilVakyanshOnDevice() {
        val modelFile = File(MODEL_PATH)
        Log.i(TAG, "Starting Android Tamil Vakyansh Benchmark on device...")
        ...
        if (session != null) {
            val testDir = File("/data/local/tmp/tamil_test")
            ...
            Log.i(TAG, "--- ON-DEVICE TAMIL BENCHMARK SUMMARY ---")
        ...
        val outJsonFile = File(context.filesDir, "tamil_android_results.json")
