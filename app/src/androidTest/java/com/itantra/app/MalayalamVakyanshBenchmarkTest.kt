...
class MalayalamVakyanshBenchmarkTest {

    companion object {
        private const val TAG = "MalayalamVakyanshBenchmark"
        private const val MODEL_PATH = "/data/local/tmp/vakyansh_malayalam_base.int8.onnx"
        private const val EXPECTED_SHA256 = "c0922d209f67461c740784770c2c53ec6160d69c25b1d8c912eee692b8b2eea6"

        val VOCAB = arrayOf(
            "<s>", "<pad>", "</s>", "<unk>", "|",
            "ം", "ഃ", "അ", "ആ", "ഇ", "ഈ", "ഉ", "ഊ", "ഋ", "എ", "ഏ", "ഐ", "ഒ", "ഓ", "ഔ",
            "ക", "ഖ", "ഗ", "ഘ", "ങ", "ച", "ഛ", "ജ", "ഞ", "ട", "ഠ", "ഡ", "ഢ", "ണ",
            "ത", "ഥ", "ദ", "ധ", "ന", "പ", "ഫ", "ബ", "ഭ", "മ", "യ", "ര", "റ", "ല", "ള", "ഴ",
            "വ", "ശ", "ഷ", "സ", "ഹ", "ാ", "ി", "ീ", "ു", "ൂ", "ൃ", "െ", "േ", "ൈ", "ൊ", "ോ",
            "്", "ൺ", "ൻ", "ർ", "ൽ", "ൾ"
        )
    }
    ...
    @Test
    fun benchmarkMalayalamVakyanshOnDevice() {
        val modelFile = File(MODEL_PATH)
        Log.i(TAG, "Starting Android Malayalam Vakyansh Benchmark on device...")
        ...
        if (session != null) {
            val testDir = File("/data/local/tmp/malayalam_test")
            ...
            Log.i(TAG, "--- ON-DEVICE MALAYALAM BENCHMARK SUMMARY ---")
        ...
        val outJsonFile = File(context.filesDir, "malayalam_android_results.json")
