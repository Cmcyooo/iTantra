...
class KannadaVakyanshBenchmarkTest {

    companion object {
        private const val TAG = "KannadaVakyanshBenchmark"
        private const val MODEL_PATH = "/data/local/tmp/vakyansh_kannada_base.int8.onnx"
        private const val EXPECTED_SHA256 = "9769b09b6c24d67acebc50f4436d1756f4a4b3ee3edec9c34099faa904f9f5a8"

        val VOCAB = arrayOf(
            "<s>", "<pad>", "</s>", "<unk>", "|",
            "ಂ", "ಃ", "ಅ", "ಆ", "ಇ", "ಈ", "ಉ", "ಊ", "ಋ", "ಎ", "ಏ", "ಐ", "ಒ", "ಓ", "ಔ",
            "ಕ", "ಖ", "ಗ", "ಘ", "ಚ", "ಛ", "ಜ", "ಝ", "ಞ", "ಟ", "ಠ", "ಡ", "ಢ", "ಣ",
            "ತ", "ಥ", "ದ", "ಧ", "ನ", "ಪ", "ಫ", "ಬ", "ಭ", "ಮ", "ಯ", "ರ", "ಲ", "ಳ", "ವ",
            "ಶ", "ಷ", "ಸ", "ಹ", "ಾ", "ಿ", "ೀ", "ು", "ೂ", "ೃ", "ೆ", "ೇ", "ೈ", "ೊ", "ೋ",
            "ೌ", "್"
        )
    }
    ...
    @Test
    fun benchmarkKannadaVakyanshOnDevice() {
        val modelFile = File(MODEL_PATH)
        Log.i(TAG, "Starting Android Kannada Vakyansh Benchmark on device...")
        ...
        if (session != null) {
            val testDir = File("/data/local/tmp/kannada_test")
            ...
            Log.i(TAG, "--- ON-DEVICE KANNADA BENCHMARK SUMMARY ---")
        ...
        val outJsonFile = File(context.filesDir, "kannada_android_results.json")
