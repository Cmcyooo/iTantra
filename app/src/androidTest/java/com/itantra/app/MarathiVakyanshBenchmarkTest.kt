...
class MarathiVakyanshBenchmarkTest {

    companion object {
        private const val TAG = "MarathiVakyanshBenchmark"
        private const val MODEL_PATH = "/data/local/tmp/vakyansh_marathi_base.int8.onnx"
        private const val EXPECTED_SHA256 = "2c503bc31cc60d1d25a407eb4776f121cd5af9952fc96f1dd14afbfce7fd3db9"

        val VOCAB = arrayOf(
            "<s>", "<pad>", "</s>", "<unk>", "|",
            "ँ", "ं", "अ", "आ", "इ", "ई", "उ", "ऊ", "ऋ", "ए", "ऐ", "ऑ", "ओ", "औ",
            "क", "ख", "ग", "घ", "च", "छ", "ज", "झ", "ञ", "ट", "ठ", "ड", "ढ", "ण",
            "त", "थ", "द", "ध", "न", "प", "फ", "ब", "भ", "म", "य", "र", "ल", "ळ",
            "व", "श", "ष", "स", "ह", "़", "ा", "ि", "ी", "ु", "ू", "ृ", "ॅ", "े",
            "ै", "ॉ", "ो", "ौ", "्"
        )
    }
    ...
    @Test
    fun benchmarkMarathiVakyanshOnDevice() {
        val modelFile = File(MODEL_PATH)
        Log.i(TAG, "Starting Android Marathi Vakyansh Benchmark on device...")
        ...
        if (session != null) {
            val testDir = File("/data/local/tmp/marathi_test")
            ...
            Log.i(TAG, "--- ON-DEVICE MARATHI BENCHMARK SUMMARY ---")
        ...
        val outJsonFile = File(context.filesDir, "marathi_android_results.json")
